...
<html lang="ja">
    ...
    <main>
        <form action="register_confirm.php"method="post" enctype="multipart/form-data">
            <div class="form_contents">
                ...
                <div class="name">
                    ...
                    <input type="text" class="formbox" size="40" name="name" reqired>

                    </div>

                    <div class="mail">
                        <div class="hissu">必須</div><label>メールアドレス</label><br>
                        <input type="text" class="formbox" size="40" name="mail" pattern="^[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$"requred>
                    </div>

                    <div class="password">
                        <div class="hissu">必須</div><label>パスワード(半角英数字６文字以上)</label><br>
                        <input type="password" class ="formbox" size="40" name="password" id="password" pattern="^[a-zA-Z0-9]{6,}$"requred>
                    </div>

                    <div class="password">
                        <div class="hissu">必須</div><label>パスワード確認</label><br>
                        <input type="password" class="formbox" size="40" name="confirm_password" id="confirm" oninput="ConfirmPassword(this)" requred>
                    </div>
        ...
        <div class="top"><a href="http://localhost/4eachblog/index.html?#">トップへ</a></div>
        </footer>
